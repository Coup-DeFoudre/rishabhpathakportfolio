    ...
    >
      <div className="grid min-h-[70vh] grid-cols-1 md:grid-cols-2 items-center">
        ...
        <div className="col-start-1 md:row-start-1">
          <h1
            className="mb-8 sm:mb-4 md:mb-6 text-[clamp(3rem,5vmin,8rem)] sm:text-[clamp(3rem,10vmin,15rem)] md:text-[clamp(3rem,15vmin,20rem)] font-extrabold leading-none tracking-tighter"
            aria-label={
